...
LOGGING_CHANNEL = 776078103696506923
...
class Stats(commands.Cog):
    ...
    async def about(self, ctx):
        ...
        support_guild = self.bot.get_guild(776078103696506920)
    ...
    async def show_guild_stats(self, ctx):
        ...
        embed = discord.Embed(title='Server Command Stats', colour=discord.Colour.dark_blue())
    ...
    async def gateway(self, ctx):
        ...
        for shard_id, shard in self.bot.shards.items():
            ...
            if badge is None:
                badge = '<:greenTick:815587577276923944>'
